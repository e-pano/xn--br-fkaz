...
function updateIcon() {
    if (isDayTime) {
        soundIcon.src = soundOn ? 'https://börü.pages.dev/icon/togglesoundDay.svg' : 'https://börü.pages.dev/icon/togglemuteDay.svg';
    } else {
        soundIcon.src = soundOn ? 'https://börü.pages.dev/icon/togglesoundNight.svg' : 'https://börü.pages.dev/icon/togglemuteNight.svg';
    }
}
...
const images = [
    imgPath + "BGlandscapeDay.jpg",
    imgPath + "BGlandscapeNight.jpg",
    imgPath + "BGportraitDay.jpg",
    imgPath + "BGportraitNight.jpg"
];
